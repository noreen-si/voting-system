...
public class CPLtests {
    ...
    public void test_parseHeader() throws IOException {
        ...
        br1.readLine();
        cplParse = new CPL(reader1List, null, br1);
    ...
    public void test_processFile() throws IOException {
        ...
        br2.readLine();
        cplProcess = new CPL(reader2List, null, br2);
    ...
    public void test_processFile_2() throws IOException {
        ...
        br3.readLine();
        cplAlgorithm = new CPL(reader3List, null, br3);
    ...
    public void test_initializeParty() throws IOException {
        ...
        br4.readLine();
        cplInitialize = new CPL(reader4List, null, br4);
    ...
    public void test_drawLotto() throws IOException {
        ...
        br5.readLine();
        cplLotto = new CPL(reader5List, null, br5);
    ...
    public void test_break_two_tie() throws IOException {
        ...
        br6.readLine();
        cplTwoTie = new CPL(reader6List, null, br6);
    ...
    public void test_break_multi_tie() throws IOException {
        ...
        br7.readLine();
        cplMultiTie = new CPL(reader7List, null, br7);
    ...
    public void test_break_lotto_tie() throws IOException {
        ...
        br8.readLine();
        cplLottoTie = new CPL(reader8List, null, br8);
    ...
    public void test_full() throws IOException {
        ...
        ArrayList<FileReader> reader9List = new ArrayList<>();
        reader9List.add(reader9);
        BufferedReader br9 = new BufferedReader(reader9);
        br9.readLine();
        cplFull = new CPL(reader9List, null, br9);
        cplFull.parseHeader();
        cplFull.processFile();
    ...
    public void test_knockout() throws IOException {
        ...
        ArrayList<FileReader> reader10List = new ArrayList<>();
        reader10List.add(reader10);
        BufferedReader br10 = new BufferedReader(reader10);
        br10.readLine();
        cplKnockout = new CPL(reader10List, null, br10);
    ...
    public void test_all_tie() throws IOException {
        ...
        ArrayList<FileReader> reader11List = new ArrayList<>();
        reader11List.add(reader11);
        BufferedReader br11 = new BufferedReader(reader11);
        br11.readLine();
        cplAllTie = new CPL(reader11List, null, br11);
    ...
    public void test_basic_file() throws IOException {
        ...
        ArrayList<FileReader> reader12List = new ArrayList<>();
        reader12List.add(reader12);
        BufferedReader br12 = new BufferedReader(reader12);
        br12.readLine();
        basic = new CPL(reader12List, null, br12);
        basic.parseHeader();
        basic.processFile();
    ...
    public void test_france() throws IOException {
        ...
        ArrayList<FileReader> reader13List = new ArrayList<>();
        reader13List.add(reader13);
        BufferedReader br13 = new BufferedReader(reader13);
        br13.readLine();
        france = new CPL(reader13List, null, br13);
        france.parseHeader();
        france.processFile();
